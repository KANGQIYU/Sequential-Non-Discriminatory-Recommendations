...
from cvxopt import solvers, matrix, spdiag, log, div
...
def entropy_constraint(c):
    ...
    def F(x=None, z=None):
        ...
        return val, Df.T, H
    return solvers.cpl(c, F, G, h, dims)['x']
...
def main():
    ...
    parser.add_argument('--runtimes', type=int, default=250, metavar='N',
    ...
    I = matrix(0.0, (n_protect_dim, n_protect_dim))
    ...
    G = -I
    h = matrix(n_protect_dim * [0.0])
    dims = {'l': n_protect_dim, 'q': [], 's': []}
