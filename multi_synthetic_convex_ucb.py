...
def runone(run_id):
    ...
    for rtime in range(args.n_trial):
        ...
        if convex_const == 'entropy':
            ...
            v.value = vv
            constant.value = args.alpha_linucbpro*np.log(rtime+1)*(n_feat_dim**0.5)
...
def main():
    ...
    parser.add_argument('--alpha_pro', type=float, default=10, metavar='M',
                        help='set parameter alpha')
    parser.add_argument('--alpha_unprotect', type=float, default=0.01, metavar='M',
                        help='set parameter alpha')
    parser.add_argument('--alpha_full', type=float, default=10, metavar='M',
                        help='set parameter alpha')
    parser.add_argument('--alpha_ground', type=float, default=0.001, metavar='M',
                        help='set parameter alpha')
    parser.add_argument('--alpha_linucb', type=float, default=0.001, metavar='M',
                        help='set parameter alpha')
    parser.add_argument('--alpha_linucbpro', type=float, default=0.001, metavar='M',
                        help='set parameter alpha')
